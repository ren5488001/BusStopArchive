 ...
 * @date 2025-11-19
 */
public interface BamsArchiveAuditLogMapper
{
    /**
     * 查询档案审计日志
     *
     ...
     * @return 结果
     */
    public int insertBamsArchiveAuditLog(BamsArchiveAuditLog bamsArchiveAuditLog);
     ...
     * @return 结果
     */
    public int batchInsertAuditLog(List<BamsArchiveAuditLog> logs);
